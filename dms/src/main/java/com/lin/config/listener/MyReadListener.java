package com.lin.config.listener;
...
@Slf4j
public class MyReadListener implements ReadListener<GradeExcel> {
     ...
     * 缓存的数据
     */
    private List<GradeExcel> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    /**
